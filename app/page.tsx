        ...
        <section className="mb-24 grid items-center gap-12 lg:grid-cols-[1.16fr_0.84fr]">
          <div>
            ...
            <div className="mt-8 flex flex-col gap-4 sm:flex-row">
              <Link
                href="/partners"
                className="inline-flex items-center justify-center rounded-full border border-primary bg-primary px-6 py-3 text-[13px] font-semibold tracking-normal text-white shadow-[0_12px_34px_rgba(139,109,255,0.22)] transition hover:shadow-[0_16px_48px_rgba(139,109,255,0.34)] hover:brightness-110"
                >
                Hire sincere talent
              </Link>
              <a
